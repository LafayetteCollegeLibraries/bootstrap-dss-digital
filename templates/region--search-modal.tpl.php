    ...
    <div class="modal-dialog">
	  ...
	  <h4 class="modal-title">Advanced Search</h4>
        ...
        <div class="modal-body">
          ...
          <?php print $content; ?>
          <button id="search-modal-help" class="btn btn-default" data-content="Search help message." data-placement="bottom" data-toggle="popover" data-container="body" type="button"><i class="icon-question-sign" title="Click for more information"></i></button>
        </div>
      </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
  </div><!-- /.modal -->
